...
A browser-based tool for creating custom GTFS-compatible transit maps. 

Add stops, draw routes, and export a valid GTFS ZIP for use in [MapCalipers](https://github.com/joshspicer/MapCalipers) - an [iOS app](https://apps.apple.com/us/app/map-calipers/id6746725018) built to help you defeat your friends in [Jet Lag: The Game Hide and Seek Transit Game](https://store.nebula.tv/products/jet-lag-the-game-hide-and-seek-transit-game)!
